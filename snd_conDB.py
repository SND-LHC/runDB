...
def add_info(path, node, level, currentlevel, print_sub_det_info=False):
    ...
    for subnode in node.GetNodes():
        ...
        if name[:8] == "Emulsion":
            ...
            # print("subdet",subdet)
            conditions_0[name] = {
                "x": fullInfo[name]["boundingbox"][0],
                "y": fullInfo[name]["boundingbox"][1],
                "z": fullInfo[name]["boundingbox"][2],
            }
            if name == "Emulsion_59":
        ...
        if 1 == 0:
            ...
            if sd == "":
                ...
                if firstsd == False:
                    ...
                    if (
                        sd[:15] == "volMuUpstreamDet"
                        and name[:16] == "volMuUpstreamBar"
                    ):
                        conditions_mu0[name] = {
                            "x": fullInfo[name]["boundingbox"][0],
                            "y": fullInfo[name]["boundingbox"][1],
                    ...
                    if (
                        sd[:17] == "volMuDownstreamDet"
                        and name[:22] == "volMuDownstreamBar_hor"
                    ):
                        conditions_mu0[name] = {
                            "x": fullInfo[name]["boundingbox"][0],
                            "y": fullInfo[name]["boundingbox"][1],
                    ...
                    if (
                        sd[:17] == "volMuDownstreamDet"
                        and name[:22] == "volMuDownstreamBar_ver"
                    ):
                        conditions_mu0[name] = {
                            "x": fullInfo[name]["boundingbox"][0],
                            "y": fullInfo[name]["boundingbox"][1],
                    ...
                    if 1 == 0:
                        ...
                        for l in range(2):
                            ...
                            for m in range(3):
                                ...
                                conditionsDB.add_detector(
                                    boardsd, sd + "/" + name + "/" + planesd
                                )
                                for n in range(8):
                                    tofpetsd = "tofpet_" + str(n)
                                    conditionsDB.add_detector(
                                        tofpetsd,
                                        sd + "/" + name + "/" + planesd + "/" + boardsd,
                                    )
                                    for o in range(64):
...
conditions = {
    ...
    "ydim": 39.0,
    "zdim": 3.0,
    "DZ": 7.790000000000001,
    "nmats": 3,
    "nscifi": 5,
    "channel_width": 0.025,
    "sipm_edge": 0.017,
    "charr_gap": 0.020000000000000004,
    "charr_width": 1.6,
    "sipm_diegap": 0.006,
    "SiPMarray_width": 3.254,
    "nsipm_channels": 128,
    "nsipm_mat": 4,
    "nsipms": 12,
    "sipmarr_width": 3.22,
    "firstChannelX": -19.528,
    "nfibers_shortrow": 471,
    "nfibers_longrow": 472,
    "nfibers_z": 6,
    "scifimat_width": 12.989999999999998,
    "scifimat_length": 39.0,
    "scifimat_z": 0.135,
    "epoxymat_z": 0.17,
    "scifimat_gap": 0.05,
    "fiber_length": 39.0,
    "scintcore_rmax": 0.011,
    "clad1_rmax": 0.01175,
    "clad2_rmax": 0.0125,
    "horizontal_pitch": 0.0275,
    "vertical_pitch": 0.021,
    "rowlong_offset": 0.035,
    "rowshort_offset": 0.0215,
    "carbonfiber_z": 0.02,
    "honeycomb_z": 0.5,
    "plastbar_x": 1.5,
    "plastbar_y": 39.0,
    "plastbar_z": 0.195,
    "scifi_separation": 10.790000000000001,
    "offset_z": -24.71,
    "timeResol": 0.15,
    "Xpos0": 4.34,
    "Ypos0": 298.94,
    ...
    "EdgeAY": 22.5,
    "EdgeAZ": 0.0,
    "FirstChannelVX": -19.528000000000002,
    "FirstChannelVY": -20.0,
    "FirstChannelVZ": -1.292,
    "FirstChannelHX": -20.0,
    "FirstChannelHY": -19.528000000000002,
    "FirstChannelHZ": -0.7070000000000001,
    "LfirstChannelVX": -19.5135,
    "LfirstChannelVY": 19.5,
    "LfirstChannelVZ": 1.185,
    "LfirstChannelHX": -19.5,
    "LfirstChannelHY": 19.5178,
    "LfirstChannelHZ": 0.625,
    "LocM100": 0.0,
    "LocM101": 0.0,
    "LocM102": 0.0,
    "LocM110": 0.0,

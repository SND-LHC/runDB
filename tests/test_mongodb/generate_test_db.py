...
condition = Condition(
    ...
    values={"name": "name detector", "value": "value detector"},
)
...
sub_condition = Condition(
    ...
    values={"name": "name sub detector", "value": "value sub detector"},
)
...
sub_sub_condition = Condition(
    name="sub_sub_detector_id_exist",
    tag="sub_sub_tag",
    type="sub_sub_type",
    ...
    values={"name": "name sub sub detector", "value": "value sub sub detector"},
)
...
sub_condition_2 = Condition(
    name="sub_condition_2",
    tag="sub_2",
    type="sub_type_2",

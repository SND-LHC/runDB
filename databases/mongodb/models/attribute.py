"""Mongo Engine model definition for an Attribute."""
...
class Attribute(EmbeddedDocument):
    """This model describes a specific (set of) attributes with value(s) associated with a Fill, Run, File, Emulsion or Brick.

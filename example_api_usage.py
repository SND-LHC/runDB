...
result = conditionsDB.get_condition_by_name_and_tag(
    "detector3/subdetector1", "conditionsName1", "SampleTag2"
)
print(result)
...
conditionsDB.get_condition_by_name_and_collection_date(
    "detector3/subdetector1", "conditionName1", "2020-03-21 18:14"
)
...
conditionsDB.get_conditions_by_name_and_validity(
    "detector3/subdetector1", "conditionName1", "2020-03-22"
)
...
conditionsDB.update_condition_by_name_and_tag(
    "detector3/subdetector1",
    "conditionName1",
    "SampleTag",
    "testType2",
